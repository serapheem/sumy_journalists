...
<div class="article-footer">
    ...
    <?php echo Helper::getSocialButtons( 'KnowOur', $record ) ?>
    
    <div class="clear"></div>
</div>
<?php $this->widget( 'application.extensions.SocialComments.SocialCommentsWidget', array( 'section' => 'KnowOur', 'item' => $record ) ); ?>
