<div id="rating" class="note fleft">
    ...
    if (isset($change_rating[$type]) && is_array($change_rating[$type])) 
    {
        $show_change_rating = !in_array($item->id, $change_rating[$type]);
    }
    ...
    if ($show_change_rating):
    ?>
        <div id="rating-down" onclick="ratingChange(<?php echo $item->id; ?>, '<?php echo $type ?>', '-1');"></div>
    <?php
    endif;
    ...
    <?php if ($show_change_rating): ?>
        <div id="rating-up" onclick="ratingChange(<?php echo $item->id; ?>, '<?php echo $type ?>', '1');"></div>
    <?php endif; ?>
    <div class="clear"></div>
</div>