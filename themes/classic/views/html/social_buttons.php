...
if ( !empty( $section ) && !empty( $item->id ) )
{
	...
	$link = Yii::app( )->createAbsoluteUrl( "/{$section}/" . $item->id );
...
<div id="vkontakte_block"><div id="vk_like" class="fleft"></div></div>

<div id="google_block"><g:plusone <?php echo $go_attr ?>></g:plusone></div>
