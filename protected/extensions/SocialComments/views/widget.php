<?php
/**
 * Layout file for SocialComments Widget
 */

if ( !empty( $section ) && !empty( $item->id ) )
{
	$link = Yii::app()->createAbsoluteUrl( '/' . strtolower( $section ) . '/' . $item->id );
	...
	jQuery(document).ready( function ($) 
	{
		...
		window.fbAsyncInit = function() 
		{
			FB.init({
				...
				channelURL : "<?php echo CHtml::encode( str_replace( 'http:', '', $link ) ) ?>",//'//WWW.YOUR_DOMAIN.COM/channel.html',
