...
class Helper 
{
     ...
     * @return string
     */
    static public function getThumbImage( $text )
    {
        // Get main image of news
        $image = '';
        $pattern = '/(img|src)=("|\')[^"\'>]+/i'; 
     ...
     * @return string
     */
    static public function getRatingButtons( $type, $item )
    {
        $html = ''; 
     ...
     * @return boolean
     */
    static public function isNewView( $type, $item )
    {
        $is_new = false;
     ...
     */
    static function addGallery($text)
    {
